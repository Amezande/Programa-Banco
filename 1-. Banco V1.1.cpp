#include #include <stdlib.h> #include <conio.h> #include <string.h>

using namespace std;

int main() { system ("color B1"); regresa: int opc,r,s; char a[20]; char b[20]; cout<<"\n\t BBVA (Banco Belico de Varios Alusines)"<<endl; cout<<"\n \t Hola Lorena Azuara!!"<<endl; system("pause"); system("cls"); cout<<"\n \t Introduzca clave..."<<endl; int i = 0;
